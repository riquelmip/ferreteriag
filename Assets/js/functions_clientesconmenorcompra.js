...
function cargar_datos(){
  ...
  $.ajax({
      dataType: "json",
      method: "POST",
      url: base_url+"/Consultas/clientemenorcompras",
      data : datos,
  }).done(function(json) {
...
$(document).on("change","#fecha_venta",function(e){
  var fecha_fin = $("#fecha_venta").val();
   ...
   $.ajax({
     dataType: "json",
     method: "POST",
     url: base_url+"/Consultas/clientemenorcomprasfiltradaporfecha/"+fecha_fin,
 ...
 function drawChart() {
   $.ajax({
     dataType: "json",
     method: "POST",
     url: base_url+"/Consultas/clientemenorcompra", 
 }).done(function(json) {
     console.log("EL consultar",json);
     for(var i in json)
 ...
 parseFloat(row.monto)
   ...
   var options = {
     title: 'Clientes con menor indice de compra',
     is3D: true,
   };
  ...
  function drawChart() {
    $.ajax({
      dataType: "json",
      method: "POST",
      url: base_url + "/Consultas/clientemenorcomprafecha/" + fecha_fin,
      }).done(function(json) {
          console.log("EL consultar",json);
          for(var i in json)
          result.push([i, json [i]]);
